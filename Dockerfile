...
# 5. Install ChromeDriver matching the installed Chrome version (134.0.6998.35)
RUN wget https://storage.googleapis.com/chrome-for-testing-public/134.0.6998.35/linux64/chromedriver-linux64.zip -O /tmp/chromedriver.zip \
